			...
			<div class="container">
				...
				<div class="innerTypeTwo">
					...
					<div class="bodyColumn">
						...
						<a href="<?php echo URL ?>event_edit/add_guest/<?php echo $this->eventid; ?>" class="signupBtn" style="font-size:14px;padding:5px 10px;">add new guest</a>
						<!--<a  style="float:left;" href="<?php echo URL ?>event_edit/add_guest">ADD NEW GUEST</a>-->
