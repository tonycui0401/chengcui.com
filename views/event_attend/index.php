					...
					<div class="sideColumn">
						<div class="content">
							...
							<div class="profileMenu">
								...
								<a href="<?php echo URL; ?>event_attend" class="active"><span><i class="icon-flag enlarge"></i><i class="icon-ok tiny"></i></span> Attended Events</a>
							</div>
					...
					<div class="bodyColumn">
						...
						<div class="eventBlk">
							<div class="eventContent">
								<a href="<?php echo URL; ?>event_attend/view"><img class="eventImg" src="<?php echo FILE_URL; ?>style/images/event_1.jpg" alt="events"></a>
								<a href="<?php echo URL; ?>event_attend/view"><h4>Betfair</h4></a>
								<p>
							...
							<div class="eventsControl">
								...
								<span class="rt">
								<!--<a href="<?php echo URL; ?>event_attend/view"> View</a--> <!--|
