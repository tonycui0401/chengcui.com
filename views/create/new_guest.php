...
<div class="profileMenu">
					...
					<div class="bodyColumn">
						...
						<div style="padding-bottom:20px;height:10px;border-bottom:1px solid #ccc;"><!--<a  style="float:left;" href="<?php echo URL ?>event_edit/add_guest">ADD NEW GUEST</a>-->
						<!--<a href="#">ADD CHECKED</a>
						...
						<a  style="float:right;" href="<?php echo URL ?>event_edit"><< Back to edit event</a>
						</div>
						<br clear=both>
				...
				<!--<div id="myac">-->
					...
					<div style="float:left;width:70px;height:20px;border:0px solid #ff0000;margin-left:10px;margin-top:0px;"><a href="#" class="signupBtn" style="font-size:14px;padding:5px 10px;">invite</a></div>
					</div>
					<div style="margin-top:10px;height:70px;width:180px;border:0px solid #ccc;float:left;margin-left:30px;">
					<div style="float:left;"><img src="<?php echo FILE_URL; ?>style/images/profile_image_placeholder.jpg" style="border:1px solid #ccc;padding:4px;background:#fff;" width="60" height="60" alt="image"></div>
					<div style="float:left;width:70px;height:30px;border:0px solid #ff0000;font-size:11pt;margin-left:10px;margin-bottom:5px;word-wrap:break-word;">rrrr</div>
